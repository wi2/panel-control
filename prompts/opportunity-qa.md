...
**Active**: [opportunity-qa-v3.md](opportunity-qa-v3.md)

## Changelog

| Version | Date | Status | Notes |
|---------|------|--------|-------|
| v3 | 2026-06-26 | active | Strategy-aware QA — solo_micro_saas hard gates + MSFI |
...
2. Execute [opportunity-qa-v3.md](opportunity-qa-v3.md) against the PR diff
