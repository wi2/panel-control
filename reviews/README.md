...
| [portfolio-review-runner-v3.md](../prompts/portfolio-review-runner-v3.md) — cron or `cp:review` | Yes |
| portfolio-review-runner — material portfolio action in run | Yes |
| Weekly cron with no due entries | No (NOOP) |

## Automated generation

The [Portfolio Review Runner](../prompts/portfolio-review-runner.md) prompt **v3** (Cursor Automation **CP — Review** via [automation-review-v3.md](../prompts/automation-review-v3.md)) processes due entries from:

- **[portfolio/micro-saas.md](../portfolio/micro-saas.md)** — canonical for `solo_micro_saas` (MONITOR_MICRO / BUILD_MICRO)
- [portfolio/monitoring.md](../portfolio/monitoring.md) and [portfolio/active.md](../portfolio/active.md) — legacy `startup_studio` only (read-only)
