...
Opportunities with score **40–69** under periodic re-evaluation.
...
1. Re-run validation (minimum) and re-score.
2. Promote to [active.md](active.md) if score >= 70.
3. Move to [archived.md](archived.md) if score < 40 or kill trigger met.
...
|----|-------|-------|-------|---------------|-------------|------|
| OPP-20260615-ai-invoice-parser | AI Invoice Parser for SMB Accountants | 55 | studio-team | 2026-06-25 | 2026-09-25 | [opportunity](../opportunities/_example-opportunity.md) |
